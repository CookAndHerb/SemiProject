					...
					<c:when test="${mvo.userNickname eq rboard.boardWriter}">
				     ...
				     <c:otherwise>
				      <div class="row float-right col-3">
						 	<a href="/RboardSearch.do?searchCategory=${searchCategory}&keyword=${keyword}&currentPage=${currentPage}" type="button" class="btn btn-secondary text-white" >목록</a>
					  </div>
					</c:otherwise>	
         	  </c:choose>
</section>
